     ...
     stage('Deploy to artifactory'){
        ...
        post {  
         ...
         success {   
            ...
            emailext attachLog: true, body: "<b>Example</b><br>Project: ${env.JOB_NAME}", from: 'vikramjenkins@outlook.com', mimeType: 'text/html', replyTo: '', subject: "Deploy Success CI: Project name -> ${env.JOB_NAME}", to: "mukeshkousalya2k17@gmail.com";
         }  
         failure {  
